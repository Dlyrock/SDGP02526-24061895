    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('TENANT', 'Tenant'), ('FRONTDESK', 'Front Desk'), ('FINANCE', 'Finance Manager'), ('MAINTENANCE', 'Maintenance Staff'), ('ADMIN', 'Administrator'), ('MANAGER', 'Manager')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ni_number', models.CharField(blank=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('cash', 'Cash'), ('check', 'Check'), ('credit_card', 'Credit Card'), ('bank_transfer', 'Bank Transfer')], max_length=50)),
